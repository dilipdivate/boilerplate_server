...
const register = catchAsync(async (req, res) => {
  ...
  const registerToken = await tokenService.generateAuthTokens(user);
...
const changePassword = catchAsync(async (req, res) => {
  await authService.changePassword(req.body.email, req.body.oldPassword, req.body.newPassword);
  res.status(httpStatus.NO_CONTENT).send();
});

...
// const { requiresToBeLoggedIn } = require('../../src/middlewares/auth');
...
describe('Auth middleware', () => {
  test('should call next with no errors if access token is valid', async () => {
    ...
    await requiresToBeLoggedIn()(req, httpMocks.createResponse(), next);
  ...
  test('should call next with forbidden error if user does not have required rights and userId is not in params', async () => {
    ...
    await requiresToBeLoggedIn('anyRight')(req, httpMocks.createResponse(), next);
  ...
  test('should call next with no errors if user has required rights', async () => {
    ...
    await requiresToBeLoggedIn(...roleRights.get('admin'))(req, httpMocks.createResponse(), next);
